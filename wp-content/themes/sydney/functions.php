...
require get_template_directory() . '/inc/about-slider.php';
require get_template_directory() . '/inc/service-slider.php';
 ...
 *Current Page url.
 */
require get_template_directory() . '/inc/current-pageurl.php';