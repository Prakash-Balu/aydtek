...
function sydney_custom_styles($custom) {
	...
	//Menu background
	$menu_bg_color = get_theme_mod( 'menu_bg_color', '#1c1c1c' );
	//$rgba = sydney_hex2rgba($menu_bg_color, 0.9);
	$rgba = sydney_hex2rgba('#1c1c1c', 0.9);
	...
	$custom .= "@media only screen and (max-width: 1024px) { .site-header { background-color:" . esc_attr('#1c1c1ce6') . ";}}" . "\n";
	//Site title
	...
	//Footer background
	$footer_background = get_theme_mod( 'footer_background', '#363636' );
