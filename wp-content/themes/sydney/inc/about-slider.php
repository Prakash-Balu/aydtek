...
//About slider template
if ( ! function_exists( 'sydney_about_slider_template' ) ) :
function sydney_about_slider_template() {
    ...
    $images = array(
    		'slider_image_1' => get_template_directory_uri().'/images/about/1.jpg',
    		'slider_image_2' => get_template_directory_uri().'/images/about/2.jpg',
    		'slider_image_3' => get_template_directory_uri().'/images/about/3.jpg',
